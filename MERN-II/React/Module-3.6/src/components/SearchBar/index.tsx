 ...
 * 1. useRef for DOM access — focus the input imperatively on mount
 * 2. Controlled input — parent owns `value`, component fires onChange
 * 3. Debounce happens UPSTREAM in App, not here — SearchBar stays simple
 *
 * CSS NOTE: the icon MUST be inside .search-input-wrap (position:relative)
 * so that its position:absolute is scoped to that container, not the page.
 */

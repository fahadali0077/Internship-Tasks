  ...
  return (
    <div className="pb-16">
      ...
      <div className="grid gap-10 lg:grid-cols-2 lg:items-start lg:gap-14">
        {/*
          ImageGallery is a Client Component (uses useState for selected image).
          It receives the product as a prop from this Server Component.
          This is the composition pattern: Server passes data → Client handles interaction.
        */}

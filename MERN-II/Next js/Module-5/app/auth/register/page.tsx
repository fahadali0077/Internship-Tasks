    ...
    <div className="mx-auto max-w-md py-8">
      <div className="rounded-2xl border border-border bg-white p-10 shadow-sm dark:border-dark-border dark:bg-dark-surface">
        <div className="mb-8 text-center">
          ...
          <h1 className="font-serif text-3xl font-normal dark:text-white">Create Account</h1>
          <p className="mt-2 text-sm text-ink-muted">Join thousands of happy shoppers</p>
        </div>
        <RegisterForm />
      </div>
    </div>

...
interface ProductCardProps {
   ...
   * Set true for the first row of cards (above the fold) to preload images
   * and improve LCP. False for all subsequent rows (lazy-loaded).
   * Module 7 wires this via the ProductRow component.
   */
  priority?: boolean;
}

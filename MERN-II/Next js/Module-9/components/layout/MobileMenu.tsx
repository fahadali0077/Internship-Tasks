...
const links = [
  ...
  { href: "/admin", label: "◈ Admin", exact: false, admin: true },
];
          ...
          <>
            ...
            >
              <ul className="flex flex-col gap-1">
                {links.map(({ href, label, exact, admin }) => {
                        ...
                        className={cn(
                          ...
                          admin
                            ? isActive
                              ...
                              : "border border-amber/30 text-amber hover:bg-amber-dim dark:hover:bg-amber/10"
                            : isActive

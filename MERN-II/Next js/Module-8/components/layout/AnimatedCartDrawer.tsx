...
/**
 * AnimatedCartDrawer — CartDrawer rebuilt with Framer Motion AnimatePresence.
 *
 * MENTAL MODEL — AnimatePresence:
 *   React normally removes components from the DOM instantly when they unmount.
 *   AnimatePresence intercepts the unmount, plays the exit animation, THEN
 *   removes the component from the DOM.
 *
 *   Without AnimatePresence: the drawer disappears instantly (no exit animation).
 *   With AnimatePresence: the drawer slides out before being removed.
 *
 *   The key prop on motion components is required for AnimatePresence to track
 *   which element is entering/exiting.
 *
 * ANIMATION VARIANTS:
 *   variants object keeps animation states readable and reusable.
 *   "hidden" → "visible" on enter; "hidden" on exit.
 */

/**
 * ProductCard — Module 7 updates:
 *   - next/image with blur placeholder + correct sizes prop
 *   - priority prop passed in for hero (first visible) cards
 *   - Playfair Display font for product name (font-serif class)
 */

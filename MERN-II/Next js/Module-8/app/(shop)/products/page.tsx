...
/**
 * ProductsPage — Module 7:
 *   ProductGrid now streams row-by-row (each row has its own Suspense).
 *   The outer Suspense here catches the initial load state before the
 *   async ProductGrid component resolves.
 */
